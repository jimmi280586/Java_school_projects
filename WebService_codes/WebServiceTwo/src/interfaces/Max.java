...
public class Max implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":max", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type", "max",
                    xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Max parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"max".equals(type)) {
                            ...
                            return (Max) interfaces.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
