...
public class Vat implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://interfaces", "vat", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":vat", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type", "vat",
                    xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Vat parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"vat".equals(type)) {
                            ...
                            return (Vat) interfaces.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
