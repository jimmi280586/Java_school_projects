...
public class Avg implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":avg", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type", "avg",
                    xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static Avg parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"avg".equals(type)) {
                            ...
                            return (Avg) interfaces.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
