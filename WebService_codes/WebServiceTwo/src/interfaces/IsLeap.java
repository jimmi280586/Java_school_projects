...
public class IsLeap implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":isLeap", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "isLeap", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static IsLeap parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            IsLeap object = new IsLeap();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"isLeap".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (IsLeap) interfaces.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
