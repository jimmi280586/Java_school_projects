...
public class TrackAnimalResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     * This was an Array!
     */
    protected model.xsd.Product[] local_return;
     ...
     * @return model.xsd.Product[]
     */
    public model.xsd.Product[] get_return() {
        return local_return;
    }
     ...
     */
    protected void validate_return(model.xsd.Product[] param) {
    }
     ...
     * @param param _return
     */
    public void set_return(model.xsd.Product[] param) {
     ...
     * @param param model.xsd.Product
     */
    public void add_return(model.xsd.Product param) {
        if (local_return == null) {
            local_return = new model.xsd.Product[] {  };
        }
        ...
        list.add(param);
        this.local_return = (model.xsd.Product[]) list.toArray(new model.xsd.Product[list.size()]);
    }
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"trackAnimalResponse".equals(type)) {
                            ...
                            return (TrackAnimalResponse) services.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list1.add(model.xsd.Product.Factory.parse(reader));
                    }
                        ...
                        if (reader.isEndElement()) {
                            ...
                            if (new javax.xml.namespace.QName(
                                ...
                                if ("true".equals(nillableValue) ||
                                    ...
                                    list1.add(model.xsd.Product.Factory.parse(
                                            reader));
                                }
                            } else {
                                loopDone1 = true;
                    ...
                    object.set_return((model.xsd.Product[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            model.xsd.Product.class, list1));
