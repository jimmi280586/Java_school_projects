...
public class BinaryTreeNode<T>
{
   ...
   /**
    * reference to the bribe of the node
    */
   ...
   /**
    * get a reference to the bribe of the node
    * @return reference to the bribe 0 if no bribe is set
    */
   ...
   /**
    * Set the bribe reference of the node
    *
    * @param bribe reference. 0 if no bribe is set.
    */
