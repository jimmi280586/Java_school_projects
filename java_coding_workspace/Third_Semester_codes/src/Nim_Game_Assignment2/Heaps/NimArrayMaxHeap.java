/**
 * Array implementation of the Maxheap abstract data type
 *
...
public class NimArrayMaxHeap<T extends Comparable<T>>
   implements ArrayMaxHeapADT<T>
{
   ...
   public NimArrayMaxHeap()
   {
      this( DEFAULT_CAPACITY );
   }


   public NimArrayMaxHeap( int initialCapacity )
   {
...
public T findMax()
   ...
   {
      if( size() == 0 )
         throw new EmptyCollectionException( "ArrayMinHeap.findMax()" );
