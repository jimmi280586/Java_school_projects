 ...
 * other algorithms. Family: Divide and conquer. Space: In-place. Stable: False.
 * Average case = O(n*log n), Worst case = O(n^2), Best case = O(n) [three-way
 * partition and equal keys] http://en.wikipedia.org/wiki/Quick_sort
 *
...
public class QuickSort<T extends Comparable<T>>
{
   ...
   public static <T extends Comparable<T>> T[] sort(PIVOT_TYPE pivotType,
         T[] unsorted)
   {
      int pivot = 0;
   ...
   private static <T extends Comparable<T>> void sort(int index, int start,
         int finish, T[] unsorted)
   {
