 ...
 * Selection. Space: In-place. Stable: False. Average case = O(n*log n) Worst
 * case = O(n*log n) Best case = O(n*log n)
...
public class HeapSort<T extends Comparable<T>>
{
   ...
   private static <T extends Comparable<T>> int add(int size, T element,
         T[] unsorted)
   {
      int length = size;
      int i = length;
