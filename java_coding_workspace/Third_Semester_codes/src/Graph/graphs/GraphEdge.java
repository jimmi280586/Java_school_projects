...
* */
public class GraphEdge <E,T> {
   // Attributes
   private GraphVertex<E,T> v1, v2;
   private DLLNode<GraphEdge<E,T>> incidentPositionV1, incidentPositionV2;
   private T label;
   private double weight;
   private DLLNode<GraphEdge<E,T>> position;
   private int status;
    ...
    * @param v2 To vertex
    */
   protected GraphEdge(GraphVertex<E,T> v1, GraphVertex<E,T> v2){
      this.v1 = v1;
      this.v2 = v2;
    ...
    */
   public GraphVertex<E,T> getOpposite(GraphVertex<E,T> v){
      if(v != v1 && v != v2)
         return null;
      return v1 == v ? v2 : v1;
   }
    ...
    */
   protected DLLNode<GraphEdge<E,T>> getPosition() {
      return position;
   }
    ...
    * @param node position
    */
   protected void setPosition(DLLNode<GraphEdge<E,T>> position) {
    ...
    */
   protected DLLNode<GraphEdge<E,T>> getIncidentPositionV1() {
    ...
    */
   protected DLLNode<GraphEdge<E,T>> getIncidentPositionV2() {
