...
package matrix.string;
import math.IntergerMatrix;
...
// vectorSize means number of rows im matrix
  ...
  {
	  return IntergerMatrix.multiply(encodingMatrix, uncodedMatrix) ;
  }

  public static int[][] decodeMatrix (int[][] decodingMatrix, int[][] codedMatrix)
  {
	  return IntergerMatrix.multiply(decodingMatrix, codedMatrix);
  }
