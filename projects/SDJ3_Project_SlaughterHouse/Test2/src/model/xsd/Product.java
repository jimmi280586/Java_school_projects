...
public class Product implements org.apache.axis2.databinding.ADBBean {
     ...
     * This was an Array!
     */
    protected model.xsd.Part[] localParts;
     ...
     */
    public model.xsd.Part[] getParts() {
        return localParts;
    }
     ...
     */
    protected void validateParts(model.xsd.Part[] param) {
    }
     ...
     * @param param Parts
     */
    public void setParts(model.xsd.Part[] param) {
        validateParts(param);
     ...
     */
    public void addParts(model.xsd.Part param) {
        if (localParts == null) {
            localParts = new model.xsd.Part[] {  };
        }
        ...
        list.add(param);
        this.localParts = (model.xsd.Part[]) list.toArray(new model.xsd.Part[list.size()]);
    }
            ...
            try {
                ...
                if ((reader.isStartElement() &&
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        list1.add(model.xsd.Part.Factory.parse(
                                reader));
                    }
                    ...
                    object.setParts((model.xsd.Part[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                            model.xsd.Part.class, list1));
