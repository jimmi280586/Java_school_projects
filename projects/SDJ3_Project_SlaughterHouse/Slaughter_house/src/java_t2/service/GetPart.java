...
public class GetPart implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":getPart", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "getPart", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static GetPart parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            GetPart object = new GetPart();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getPart".equals(type)) {
                            ...
                            return (GetPart) java_t2.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
