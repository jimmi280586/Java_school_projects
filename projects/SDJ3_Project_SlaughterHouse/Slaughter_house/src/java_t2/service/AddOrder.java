...
public class AddOrder implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":addOrder", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "addOrder", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static AddOrder parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AddOrder object = new AddOrder();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addOrder".equals(type)) {
                            ...
                            return (AddOrder) java_t2.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
