...
public class AddTray implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":addTray", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "addTray", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static AddTray parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AddTray object = new AddTray();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addTray".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddTray) java_t2.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
