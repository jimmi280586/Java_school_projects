...
/**
 *  MakeOrder bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class MakeOrder implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":makeOrder", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "makeOrder", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static MakeOrder parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            MakeOrder object = new MakeOrder();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"makeOrder".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (MakeOrder) java_t2.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
