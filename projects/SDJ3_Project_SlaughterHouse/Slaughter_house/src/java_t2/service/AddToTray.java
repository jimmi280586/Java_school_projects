...
/**
 *  AddToTray bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AddToTray implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":addToTray", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "addToTray", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static AddToTray parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            AddToTray object = new AddToTray();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addToTray".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddToTray) java_t2.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
