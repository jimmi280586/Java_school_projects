...
/**
 *  AddAnimal bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AddAnimal implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static AddAnimal parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addAnimal".equals(type)) {
                            ...
                            return (AddAnimal) java_t2.service.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
